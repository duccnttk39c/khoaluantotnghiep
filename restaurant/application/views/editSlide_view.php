			...
			<div class="col-sm-6 push-sm-3"> 
				...
				<form action="Slide/editSlide" method="POST" enctype="multipart/form-data">
					...
					<fieldset class="form-group">
						<input type="hidden" name="id[]" class="form-control" id="id" value="<?= $value['id'] ?>" required="">
					</fieldset>
					<fieldset class="form-group">
					...
					<fieldset class="form-group">
						...
						<input type="text" name="button_link[]" class="form-control" id="button_link" value="<?= $value['button_link'] ?>" required="">
					</fieldset>
					<fieldset class="form-group">
						<label for="formGroupExampleInput">Text của nút</label>
						<input type="text" name="button_text[]" class="form-control" id="button_text" value="<?= $value['button_text'] ?>" required="">
					</fieldset>
					<fieldset class="form-group">
