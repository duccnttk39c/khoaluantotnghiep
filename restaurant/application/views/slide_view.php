			...
			<div class="form-group row">
				...
				<div class="col-sm-6">
					<div class="row">
						...
						<div class="col-sm-9">
							<input name="slide_image" type="file" class="form-control" id="slide_image" required="">
						</div>
					</div>
				</div>
			</div>
			<div class="form-group row">
				...
				<div class="col-sm-6">
					<div class="row">
						...
						<div class="col-sm-9">
							<input name="description" type="text" class="form-control" id="description" placeholder="Mô tả" required="">
						</div>
					</div>
				</div>	
			</div>
			<div class="form-group row">
				<div class="col-sm-6">
					<div class="row">
						...
						<div class="col-sm-9">
							<input name="button_link" type="text" class="form-control" id="button_link" placeholder="Link nút" required="">
						</div>
					</div>
				</div>
				<div class="col-sm-6">
					<div class="row">
						...
						<div class="col-sm-9">
							<input name="button_text" type="text" class="form-control" id="button_text" placeholder="Text nút" required="">
						</div>
					</div>
				</div>
			</div>
